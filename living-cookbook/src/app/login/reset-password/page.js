            ...
            <div style={{ maxWidth: '400px', width: '100%', background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px', padding: '40px', textAlign: 'center' }}>
                ...
                {status === 'done' ? (
                    <>
                        ...
                        <h1 className="font-heading" style={{ fontSize: '1.8rem', marginBottom: '12px', color: 'var(--color-on-surface)' }}>Password updated!</h1>
                        <p style={{ color: 'var(--color-on-surface-muted)', fontSize: '0.9rem' }}>Taking you to the kitchen…</p>
                    </>
                ) : (
                    <>
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                            {[
                                ...
                                <div key={label} style={{ textAlign: 'left' }}>
                                    <label className="pp-overline" style={{ marginBottom: '8px', display: 'block' }}>{label}</label>
                                    <input
                                        type="password"
                                        value={value}
                            ...
                            <button
                                ...
                                style={{ marginTop: '6px', padding: '14px', background: 'var(--color-primary)', color: 'var(--color-bg)', border: 'none', borderRadius: '12px', fontWeight: 700, fontSize: '1rem', cursor: 'pointer', opacity: status === 'loading' ? 0.7 : 1 }}
                            >
